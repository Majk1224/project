...
handler.on('push', function (event) {
    console.log('Received a push event for %s to %s',
        ...
        event.payload.ref);
    run_cmd('sh', ['/home/ubuntu/deploy/majinkai/deploy.sh', event.payload.repository.name], function (text) {
        console.log(text)
...
function sendMials(event){
    ...
    // 配置收件人
    let mailOptions = {
        from: '"jason👻" <342690199@qq.com>', // sender address
	...
	<section>
		...
		<p>----------------------------</p>
		${commits}
		<a href="https://github.com/majk1224/project">点击查看</a>
	</section>` // html body
    };
    // 拼接提交记录
